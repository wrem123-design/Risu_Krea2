...
class RepositoryArtifactTests(unittest.TestCase):
    ...
    def test_module_generation_controls_are_wired_to_prompt_and_validator(self) -> None:
        ...
        self.assertIn("cast coverage as a soft secondary objective", builder.MAIN_INSTRUCTIONS)
        self.assertIn("Never invent or promote a passive bystander", builder.MAIN_INSTRUCTIONS)
    ...
    def test_missing_images_are_completed_one_at_a_time_before_generation(self) -> None:
        ...
        self.assertIn("for attempt = 1, 4", builder.GENERATOR_LUA)
        ...
        self.assertIn("resolveSceneSelectionGuidance", builder.GENERATOR_LUA)
    ...
    def test_camera_observer_rule_preserves_story_body_orientation(self) -> None:
        ...
        self.assertIn("sanitizeSceneSlots", builder.GENERATOR_LUA)
        self.assertIn("descriptorSlotIsAvailable", builder.GENERATOR_LUA)
        self.assertIn("sceneSlotsNeedRebuild", builder.GENERATOR_LUA)
        self.assertNotIn("slot: 0]]", builder.GENERATOR_LUA)
        ...
        self.assertIn("formatInlineFailure", on_output)
    ...
    def test_extra_character_memory_is_isolated_from_canonical_lorebook(self) -> None:
        ...
        self.assertIn("identity.source == 'extra' and aliasGroup == nil", builder.GENERATOR_LUA)
        ...
        self.assertIn("canonicalNames[normalizeIdentity(saved.name)]", builder.GENERATOR_LUA)
    ...
    def test_module_is_valid_positive_only_krea2_4421_archive(self) -> None:
        with zipfile.ZipFile(module_path()) as archive:
        ...
        self.assertIn("character_count: n", entries["lb-xnai.lb.format"])
    ...
    def test_builder_compiles_and_hook_patch_contains_routing_contract(self) -> None:
        ...
        self.assertIn("split_character_aliases", patch)
        self.assertIn("Stella, Song Hee-jin", patch)
        self.assertIn("쉼표로 구분한 이름 중 하나와 일치", patch)
