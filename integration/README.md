...
1. Open Settings → Modules and import
   `E:\Chatbot\Download\모듈\🔦라이트보드 🌠 삽화 Krea2 4.4.18.module.charx`.
...
Version 4.4.18 declares `character_count` as 1, 2, or 3. It retains dialogue,
...
The 4.4.18 output hook removes malformed descriptors before any ComfyUI request,
...
an unrelated name mentioned only elsewhere is not sufficient. Ungrounded substitutions are
